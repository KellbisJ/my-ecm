		...
		<>
			{loading ? (
				...
				<div className="bg-white rounded-lg shadow-md mb-4 p-4 max-w-sm relative">
					<button className="absolute top-0 left-0 text-gray-500 hover:text-red-500 transition duration-300 px-2" onClick={handleRemoveFromCart}>
					...
					<div className="text-center">
						...
						<div className="flex items-center justify-center mb-2">
							<button className="text-gray-500 hover:text-red-500 transition duration-300 mr-3" onClick={() => handleUpdateProductOrder(false)}>
								<FontAwesomeIcon icon={faMinus} />
							</button>
							<button className="text-gray-500 hover:text-indigo-500 transition duration-300" onClick={() => handleUpdateProductOrder(true)}>
